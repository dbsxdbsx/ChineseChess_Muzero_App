...
class BridgeGeneratedSharedPlatform
    extends FlutterRustBridgeBase<BridgeGeneratedSharedWire>
    with FlutterRustBridgeSetupMixin {
  BridgeGeneratedSharedPlatform(FutureOr<WasmModule> dylib)
      : super(BridgeGeneratedSharedWire(dylib)) {
...
class BridgeGeneratedSharedWasmModule implements WasmModule {
  ...
  external BridgeGeneratedSharedWasmModule bind(
      dynamic thisArg, String moduleName);
}

// Section: WASM wire connector

class BridgeGeneratedSharedWire
    extends FlutterRustBridgeWasmWireBase<BridgeGeneratedSharedWasmModule> {
