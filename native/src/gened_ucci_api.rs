...
fn wire_subscribe_ucci_engine_impl(
    ...
    engine_path: impl bridge_generated_shared::Wire2Api<String> + UnwindSafe,
) {
...
fn wire_write_to_process_impl(
    port_: MessagePort,
    command: impl bridge_generated_shared::Wire2Api<String> + UnwindSafe,
    msec: impl Wire2Api<u32> + UnwindSafe,
    player: impl Wire2Api<Player> + UnwindSafe,
    check_str_option: impl bridge_generated_shared::Wire2Api<Option<String>> + UnwindSafe,
) {
...
fn wire_is_process_loaded_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, bool, _>(
        ...
        move || {
            let api_msec = msec.wire2api();
            let api_player = player.wire2api();
            move |task_callback| Result::<_, ()>::Ok(is_process_loaded(api_msec, api_player))
        },
    )
}
fn wire_is_process_unloaded_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, bool, _>(
        ...
        move || {
            let api_msec = msec.wire2api();
            let api_player = player.wire2api();
            move |task_callback| Result::<_, ()>::Ok(is_process_unloaded(api_msec, api_player))
        },
    )
}
fn wire_get_engine_name_impl(port_: MessagePort, player: impl Wire2Api<Player> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String, _>(
        ...
        move || {
            let api_player = player.wire2api();
            move |task_callback| Result::<_, ()>::Ok(get_engine_name(api_player))
        },
    )
}
